...
describe SocialIconsHelper do
  ...
  it "should produce a valid 32 pixel icon without a tooltip" do
    helper.sm_icon(name: "twitter", href: sm_twitter_path).should eq("<a class=\"sm_32_icon sm_32_twitter sm_shadow\" data-placement=\"bottom\" href=\"/social_icons/twitter\" rel=\"\"><span></span></a>")
  end
